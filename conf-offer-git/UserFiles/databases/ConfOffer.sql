...
--
-- Host: 127.0.0.1    Database: ConfOffer
-- ------------------------------------------------------
...
--
-- Table structure for table `ConfOfferAudits`
--

DROP TABLE IF EXISTS `ConfOfferAudits`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ConfOfferAudits` (
  `idAudits` int(11) NOT NULL AUTO_INCREMENT,
  `auditContent` varchar(4096) COLLATE utf8_bin DEFAULT NULL,
  `auditDatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`idAudits`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ConfOfferAudits`
--

LOCK TABLES `ConfOfferAudits` WRITE;
/*!40000 ALTER TABLE `ConfOfferAudits` DISABLE KEYS */;
/*!40000 ALTER TABLE `ConfOfferAudits` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-07-15  7:31:20
